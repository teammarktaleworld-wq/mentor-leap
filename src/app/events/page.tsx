          ...
          {loading ? (
            ...
            <Reveal key={ev.id} delay={i * 0.1}>
              <div className="relative pt-4">
                {ev.id === "interview-to-offer-letter" && (
                  <div className="absolute top-0 left-5 z-10 bg-[#3b5bdb] text-white text-[10px] font-black uppercase tracking-[0.15em] px-4 py-1.5 rounded-full">
                    Upcoming Event
                  </div>
                )}
                <Card>
