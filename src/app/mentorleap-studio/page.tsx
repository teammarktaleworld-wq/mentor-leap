...
export default function StudioPage() {
  ...
  const featuredVideo = {
    title: "The Art of Storytelling in Business",
    category: "Featured Workshop",
    // YouTube video ID extracted from: https://youtu.be/pV80IWrilYo
    youtubeId: "pV80IWrilYo",
    poster: "https://marktaleevents.com/mentorleap/wp-content/uploads/2026/03/MriduBhandari_ProfilePic.jpg",
    duration: "12:45"
  };
  ...
  return (
    <PageWrapper>
      ...
      <section className="px-5 pb-[120px] max-w-[1200px] mx-auto">
        {/* FEATURED VIDEO */}
        <Reveal>
          <div className="aspect-video w-full rounded-[40px] bg-[#0f172a] relative overflow-hidden border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.6)] mb-20">
            ...
            {isPlaying ? (
              ...
              >
                ...
                {/* Play button */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-24 h-24 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center text-white/90 border border-white/20 group-hover:scale-110 group-hover:bg-[#00e5ff]/20 group-hover:border-[#00e5ff]/50 transition-all shadow-2xl">
                    <PlayCircle size={48} />
                  </div>
                </div>
                ...
                <div className="absolute bottom-10 left-10 right-10">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="px-3 py-1 rounded-full bg-[#00e5ff]/20 text-[#00e5ff] text-[10px] font-black uppercase tracking-widest">
        ...
        <div className="flex items-center justify-between mb-12 border-b border-white/5 pb-8">
          ...
          <Link href="/blog" className="text-[#00e5ff] text-xs font-black uppercase tracking-widest hover:underline underline-offset-8">
            Explore All
          </Link>
        </div>
                ...
                <Link href={`/blog/${blog.id}`}>
                  <Card className="h-full !p-0 bg-white/[0.02] border-white/5 hover:border-[#00e5ff]/30 transition-all group overflow-hidden border">
                    ...
                    <div className="p-8">
                      ...
                      <h4 className="text-xl font-bold text-white mb-4 leading-snug group-hover:text-[#00e5ff] transition-colors">
                        {blog.title}
                      </h4>
                      <div className="flex items-center gap-3 text-[#475569] text-[10px] font-black uppercase tracking-widest">
                        <span>{blog.readTime || "5 Min Read"}</span>
